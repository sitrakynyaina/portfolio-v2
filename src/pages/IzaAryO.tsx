...
export default function VlogIzaAryO() {
  const { t, lang } = useApp()
  const content = vlogIzaAryO[lang]
      ...
      <section className="paper-texture relative overflow-hidden pb-16 pt-16 sm:pt-20">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a href="/projects/iza-ary-o/github" target="_blank" rel="noreferrer" className="retro-btn bg-ink text-cream-light dark:bg-orange dark:text-ink">
              <Github size={16} />
