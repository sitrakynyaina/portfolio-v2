...
import { vlogSafeAI, type VlogPhase, type VlogScreenshot } from '@/data/vlogSafeAI'
...
export default function VlogSafeAI() {
  const { t, lang } = useApp()
  const content = vlogSafeAI[lang]
  ...
  return (
    <div className="min-h-screen bg-cream text-ink dark:bg-background">
      ...
      <section className="paper-texture relative overflow-hidden pb-16 pt-16 sm:pt-20">
        {/* Icônes thématiques changées pour coller au concept vocal et spatial */}
        <Map className="absolute left-[6%] top-24 hidden h-14 w-14 -rotate-12 text-ink/20 md:block" strokeWidth={1.5} />
        <Mic className="absolute right-[8%] top-20 hidden h-16 w-16 rotate-6 text-ink/20 md:block" strokeWidth={1.5} />
        <Flame className="absolute bottom-10 left-[10%] hidden h-12 w-12 rotate-12 text-ink/20 md:block" strokeWidth={1.5} />
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a href="https://github.com/IorYohanna/DevFest-AI-For-Mankind.git" target="_blank" rel="noreferrer" className="retro-btn bg-ink text-cream-light dark:bg-orange dark:text-ink">
              <Github size={16} />
      ...
      <section ref={closingRef} className="mx-auto max-w-4xl scroll-mt-24 px-4 py-16 sm:px-6">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <a href="https://github.com/IorYohanna/DevFest-AI-For-Mankind.git" target="_blank" rel="noreferrer" className="retro-btn bg-card text-ink">
            <Github size={16} />
            {t.sections.githubBtn}
          </a>
        </div>
