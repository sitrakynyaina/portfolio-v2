...
import { vlogCodeKids, type VlogPhase, type VlogScreenshot } from '@/data/vlogCodeKids'
...
export default function VlogCodeKids() {
  const { t, lang } = useApp()
  const content = vlogCodeKids[lang]
    ...
    <div className="min-h-screen bg-cream text-ink dark:bg-background">
      ...
      <section className="paper-texture relative overflow-hidden pb-16 pt-16 sm:pt-20">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a href="https://github.com/HerizoRand/Devhunt2025.git" target="_blank" rel="noreferrer" className="retro-btn bg-ink text-cream-light dark:bg-orange dark:text-ink">
              <Github size={16} />
      ...
      <section ref={closingRef} className="mx-auto max-w-4xl scroll-mt-24 px-4 py-16 sm:px-6">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <a href="https://github.com/HerizoRand/Devhunt2025.git" target="_blank" rel="noreferrer" className="retro-btn bg-card text-ink">
            <Github size={16} />
            {t.sections.githubBtn}
          </a>
        </div>
